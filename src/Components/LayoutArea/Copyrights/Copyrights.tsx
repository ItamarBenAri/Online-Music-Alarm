                    ...
                    <Grid container spacing={5}>
                        <Grid item xs={12} sm={4}>
                            ...
                            <Typography variant="body2" color="text.secondary">
                                We believe everyone should be free to experience the world. For us, there's no greater freedom than choosing when to wake up and how to start your day.<br /><br />
                                That's why we're making it simple to set up alarms, allowing everyone to start their day in the most convenient way for them.
                            </Typography>
                        </Grid>
                        <Grid item xs={12} sm={4}>
                            <Typography variant="h6" color="text.primary" gutterBottom>
